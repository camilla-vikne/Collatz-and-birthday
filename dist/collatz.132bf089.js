...
})({"9BwVn":[function(require,module,exports) {
...
function collatzFunction(n) {
    ...
    if (Number.isInteger(n) && n > 0) {
        ...
        document.getElementById("output").innerHTML = `${initalValue} used ${count} steps to reach 1, and the highest value reached was ${maxNumber}`;
        console.log(countArray);
    } else document.getElementById("output").innerHTML = `please enter a valid integer number`;
    destroyChart();
    createChart();
}
let myChart;
...
function createChart() {
    ...
    myChart = new (0, _autoDefault.default)(document.getElementById("acquisitions"), {
        type: "line",
        data: {
...
},{}]},["9BwVn","1rxKZ"], "1rxKZ", "parcelRequire30ab")

//# sourceMappingURL=collatz.132bf089.js.map
