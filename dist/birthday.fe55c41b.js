...
function onClick(event) {
    const days = 365, people = document.getElementById("people").value;
    group = document.getElementById("group").value;
    const result = probability.calculation(days, people, group);
    document.getElementById("results").innerHTML = "The average probability of a pair having the same birthday in a set of " + people + " people over " + group + " test groups, there were two or more people who shared a birthday in " + result + "% of the test groups.";
}

//# sourceMappingURL=birthday.fe55c41b.js.map
